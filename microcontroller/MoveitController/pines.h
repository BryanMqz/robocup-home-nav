...
void declaraPines(){
   ...
   pinzaGarraI.attach(44);  // vincula el servo al pin digital 9
   pinzaGarraD.attach(45);  // vincula el servo al pin digital 9
   basePinzaJoint.attach(46);  // vincula el servo al pin digital 9
}
